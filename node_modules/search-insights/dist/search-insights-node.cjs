...
function getFunctionalInterface(instance) {
    return function (functionName) {
        ...
        if (functionName && isFunction(instance[functionName])) {
            // @ts-expect-error
            instance[functionName].apply(instance, functionArguments);
        }
        else {
            // eslint-disable-next-line no-console
...
function clickedObjectIDsAfterSearch() {
    ...
    events.forEach(function (ref) {
        ...
        return objectIDs.forEach(function (objectID) { return storeQueryForObject(index, objectID, queryID); });
    });
